...
- 11 个公开项目，代表项目包括 LLM-Wiki, vectorpeak-blogs, carbon-tower-predictor, codex-pet-live, industrial-fault-text-classifier, OpenSense, vectorpeak-agent-skills, kaggle-tabular-forge, lingban-ai-chat, VectorPeak, KnowFoundry-RAG-Console。
...
| Coding&nbsp;agents | [VectorPeak](https://github.com/VectorPeak/VectorPeak) | 1+ | 个人 GitHub Profile README 仓库，包含自动收集公开项目事实并定时更新主页的工作流。 |
...
- 11 public projects, led by LLM-Wiki, vectorpeak-blogs, carbon-tower-predictor, codex-pet-live, industrial-fault-text-classifier, OpenSense, vectorpeak-agent-skills, kaggle-tabular-forge, lingban-ai-chat, VectorPeak, KnowFoundry-RAG-Console.
...
| Coding&nbsp;agents | [VectorPeak](https://github.com/VectorPeak/VectorPeak) | 1+ | Personal GitHub Profile README repository with an automated workflow for collecting public project facts and refreshing the profile. |
