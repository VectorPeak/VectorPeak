...
ZH_CONTRIBUTION_FIXES = {
    "Improve event connection handling and reconnection logic": "改进事件连接处理与重连逻辑，增强断线后的恢复能力并提升长连接稳定性",
}
...
def render_contributions(lines: list[str], contributions: list[dict[str, Any]], lang: str) -> None:
    ...
    for area in ordered_areas:
        lines.extend([
            ...
            f'      <th align="center" width="70%">What I Fixed{CONTRIBUTION_TABLE_FILLER}</th>',
            "    </tr>",
            "  </thead>",
            "  <tbody>",
        ])
